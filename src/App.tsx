						...
						return (
							...
							>
								<div 
									...
									className={(submenuStates[personid]?"bg-cyan-600 text-white hover:text-white ":"text-cyan-700 hover:bg-sky-100 hover:text-teal-950 ") + "group h-12 flex flex-row items-center py-2 px-4 hover:cursor-pointer text-sm"}
								>
									<div className='flex flex-row flex-grow items-center ms-0 group-hover:ms-[0.25rem] font-normal group-hover:font-bold transition-all'>
								...
								<div className={(submenuStates[personid] || "hidden ") + 'overflow-hidden border-x-4 border-b-4 border-cyan-600 rounded-b-lg'}>
